...
```
<sub>Create the static library `libmy.a` containing all the functions listed below:
...
```
<sub>If you haven’t coded all of the above functions create empty ones with the right prototype.
Don’t forget to push your `main.h` file to your repository. It should at least contain all the prototypes of the above functions.

```
gpradinett@ubuntu:~/0x09. Static Librairies$ ar -t libmy.a 
0-isupper.o
0-memset.o
0-strcat.o
1-isdigit.o
...
9-strcpy.o
_putchar.o
gpradinett@ubuntu:~/0x09. Static Librairies$ nm libmy.a 
...
0000000000000000 T _putchar
                 U write
gpradinett@ubuntu:~/0x09. Static Librairies$ cat main.c 
#include "main.h"
...
gpradinett@ubuntu:~/0x09. Static Librairies$ gcc -std=gnu89 main.c -L. -lmy -o quote
gpradinett@ubuntu:~/0x09. Static Librairies$ ./quote 
"At the end of the day, my goal was to be the best hacker"
    - Kevin Mitnick
gpradinett@ubuntu:~/0x09. Static Librairies$ 
```
...
A library is not a luxury but one of the necessities of life
```
<sub>Create a script called `create_static_lib.sh` that creates a static library called `liball.a` from all the `.c` files that are in the current directory.

```
gpradinett@ubuntu:~/0x09. Static Librairies$ ls *.c
0-isupper.c  0-strcat.c  1-isdigit.c  1-strncat.c  2-strlen.c   3-islower.c  3-strcmp.c  4-isalpha.c  5-strstr.c  9-strcpy.c  _putchar.c
0-memset.c   100-atoi.c  1-memcpy.c   2-strchr.c   2-strncpy.c  3-puts.c     3-strspn.c  4-strpbrk.c  6-abs.c
gpradinett@ubuntu:~/0x09. Static Librairies$ ./create_static_lib.sh 
gpradinett@ubuntu:~/0x09. Static Librairies$ ls *.a
liball.a
gpradinett@ubuntu:~/0x09. Static Librairies$ ar -t liball.a
0-isupper.o
0-memset.o
0-strcat.o
100-atoi.o
